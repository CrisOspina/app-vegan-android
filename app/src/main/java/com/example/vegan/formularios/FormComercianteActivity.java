...
public class FormComercianteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_comerciante);
    ...
    public void registrarComerciante(View view) {
        ...
        if (cedula.isEmpty()) {
            Toast.makeText(FormComercianteActivity.this, "Digita tu identificación", Toast.LENGTH_SHORT).show();
            return;
        }
        if (nombre.isEmpty()) {
            Toast.makeText(FormComercianteActivity.this, "Digita tu nombre", Toast.LENGTH_SHORT).show();
            return;
        }

        if (apellidos.isEmpty()) {
            Toast.makeText(FormComercianteActivity.this, "Digita tus apellidos", Toast.LENGTH_SHORT).show();
            return;
        }

        if (ciudad.isEmpty()) {
            Toast.makeText(FormComercianteActivity.this, "Digita tu ciudad", Toast.LENGTH_SHORT).show();
            return;
        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(FormComercianteActivity.this, "No registrado, tu correo ya existe", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    public void registrarUsuarios(final String cedula, String nombre, String apellidos,
        ...
        db.collection("FormComerciantes")
                .add(user)
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        Toast.makeText(FormComercianteActivity.this, "Usuario registrado exitosamente", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(FormComercianteActivity.this, "Error al registrar", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}